document.addEventListener("DOMContentLoaded", () => {
    ...
    function setInitialState() {
        ...
        changePhotoBtn.style.display = "none"; // 🔥 FIX
        isEditMode = false;
    }
   ...
   function loadProfile() {
       ...
       .then(user => {
           ...
           if (user.status === "success") {
               ...
               console.log("unable to get user data:" +  user.message);
    ...
    saveBtn.onclick = () => {
        ...
        .then(() => {
            loadProfile();
            profileTab.click(); // go back to profile
        });
    };
    ...
    // INIT
    // ----------------------
    setInitialState(); // 🔥 THIS FIXES YOUR BUG
    loadProfile();
});
